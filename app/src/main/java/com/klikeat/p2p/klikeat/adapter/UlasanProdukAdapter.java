...
public class UlasanProdukAdapter extends RecyclerView.Adapter<UlasanProdukAdapter.ViewHolder> {

    private Context context;
    private ArrayList<UlasanModel> ulasanModels;

    public UlasanProdukAdapter(Context context, ArrayList<UlasanModel> ulasanModels) {
